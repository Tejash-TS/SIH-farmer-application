...
$products = $buyerDAO->getVendorProducts($limit, $offset, $search, $type);
$cart_count = count($buyerDAO->getCartItems($user_id));

$types_result = $conn->query("SELECT DISTINCT type FROM products WHERE is_active = 'Y' AND product_source = 'vendor' ORDER BY type");
$types = [];
    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6"><h1 class="m-0">Vendor Products</h1></div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="buyer/dashboard">Home</a></li>
                            <li class="breadcrumb-item active">From Vendors</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="card shadow-sm mb-4">
                    <div class="card-body">
                        <form method="get" class="row g-3">
                            <div class="col-md-6">
                                <input type="text" name="search" class="form-control" placeholder="Search vendor products..." value="<?php echo htmlspecialchars($search); ?>">
                            </div>
                            <div class="col-md-3">
                ...
                <?php if (empty($products)): ?>
                    <div class="alert alert-info"><i class="fas fa-info-circle"></i> No vendor products found.</div>
                <?php else: ?>
                    <div class="row">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
                                <div class="card product-card shadow-sm h-100">
                                    <div style="height: 200px; overflow: hidden; background-color: #f0f0f0;" class="position-relative">
                                        ...
                                        <?php endif; ?>
                                        <span class="badge badge-primary position-absolute" style="top: 10px; right: 10px;">🏪 Vendor</span>
                                    </div>
                                    <div class="card-body d-flex flex-column">
                                        <h6 class="card-title"><?php echo htmlspecialchars($product['pro_name']); ?></h6>
                                        <p class="small text-muted mb-1"><i class="fas fa-building"></i> <?php echo htmlspecialchars($product['company_name'] ?? 'Unknown Vendor'); ?></p>
                                    ...
                                    <div class="card-footer bg-light p-2">
                                        <div class="btn-group btn-block">
                                            <a href="buyer/product_detail?id=<?php echo urlencode(ed('en', $product['pro_id'])); ?>&source=vendor" class="btn btn-sm btn-info"><i class="fas fa-eye"></i> View</a>
